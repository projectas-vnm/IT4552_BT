...
<body>
    <?php
        ...
        if (isset($_POST["name"]) && isset($_POST["address"]) && isset($_POST["city"]) && isset($_POST["phone"]) && isset($_POST["url"]) && isset($_POST['categories'])) {
            $name = $_POST["name"];
            ...
            <tr>
                ...
                <td>
                    <table style="width:100%">
                        <th></th><th></th>
                        <tr>
                            <td style="width: 20%">Business Name</td><td><input type="text" style="width: 50%" name="name"></td>
                        </tr>
                        <tr>
                            <td>Address</td><td><input type="text" style="width: 50%" name="address"></td>
                        </tr>
                        <tr>
                            <td>City</td>
                            <td>
                                <input type="text" style="width: 50%" name="city">
                            </td>
                        </tr>
                        <tr>
                            <td>Telephone</td><td><input type="text" style="width: 50%" name="phone"></td>
                        </tr>
                        <tr>
                            <td>URL</td><td><input type="text" style="width: 50%" name="url"></td>
                        </tr>
                    </table>
                </td>
            </tr>
